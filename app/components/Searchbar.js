...
const Searchbar = () => {
  ...
  return (
    <div className="flex">
      <p className="text-2xl font-bold m-7 font-family relative">
        {session ? (
          <span className="relative text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-purple-500">
